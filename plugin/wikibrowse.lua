...
vim.api.nvim_create_user_command("Wikibrowse", function(args)
        require("wikibrowse").search(args.args)
end, { nargs = "+" })
...
if vim.g.wikibrowse == nil or vim.g.wikibrowse.default ~= false then
        vim.g.wikibrowse = vim.tbl_deep_extend(
                "force",
                DEFAULTS,
                vim.g.wikibrowse or {}
        )
